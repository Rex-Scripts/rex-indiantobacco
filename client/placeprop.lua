...
function PropPlacer(outputitem, prop, inputitem)
    ...
    local tempObj = CreateObject(PropHash, pos.x, pos.y, pos.z -0.8, false, false, false)
    local tempObj2 = CreateObject(PropHash, pos.x, pos.y, pos.z -0.8, false, false, false)
    ...
    while true do
        ...
        if PromptHasHoldModeCompleted(SetPrompt) then
            ...
            TriggerEvent('rex-indiantobacco:client:plantnewseed', outputitem, inputitem, PropHash, pPos, heading )
...
RegisterNetEvent('rex-indiantobacco:client:preplantseed', function( outputitem, prop, inputitem )
